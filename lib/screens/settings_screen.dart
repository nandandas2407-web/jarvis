...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  void initState() {
    ...
    _githubTokenController = TextEditingController(text: widget.aiService.githubToken);
    ...
    _githubTokenController.addListener(_autoSave);
  ...
  void dispose() {
    ...
    _githubTokenController.removeListener(_autoSave);
  ...
  void _autoSave() {
    ...
    widget.aiService.saveGitHubToken(_githubTokenController.text.trim());
            ...
            children: [
              ...
              TextField(
                ...
                decoration: _buildInputDecoration(
                  ...
                  suffixIcon: IconButton(
                    icon: Icon(
                      _obscureGithubKey ? Icons.visibility_off : Icons.visibility,
                      size: 18,
                    ),
                    onPressed: () => setState(() => _obscureGithubKey = !_obscureGithubKey),
                  ),
                ),
                obscureText: _obscureGithubKey,
              ),
              const SizedBox(height: 12),
              TextField(
